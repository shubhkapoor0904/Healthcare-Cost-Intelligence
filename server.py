...
PROCEDURES: list[Procedure] = [
    Procedure("knee_replacement", "Knee replacement", "Osteoarthritis of knee", "M17.1", "Orthopedics", "major", ("knee pain", "knee replacement", "arthritis knee", "joint replacement"), "3-5 days", "4-8 weeks"),
    Procedure("angioplasty", "Coronary angioplasty", "Coronary artery disease", "I25.1", "Cardiology", "major", ("chest pain", "blocked artery", "angioplasty", "stent", "heart pain"), "1-2 days", "1-2 weeks"),
    Procedure("appendectomy", "Appendectomy", "Acute appendicitis", "K35.8", "General Surgery", "moderate", ("appendix", "appendicitis", "right lower abdomen"), "1-2 days", "2-4 weeks"),
    Procedure("c_section", "Caesarean delivery", "Pregnancy requiring surgical delivery", "O82.9", "Obstetrics", "moderate", ("c section", "cesarean", "delivery", "pregnancy surgery"), "3-4 days", "4-6 weeks"),
    Procedure("normal_delivery", "Normal delivery", "Pregnancy", "O80", "Obstetrics", "low", ("normal delivery", "delivery", "labor", "pregnancy"), "1-2 days", "2-4 weeks"),
    Procedure("cataract", "Cataract surgery", "Senile cataract", "H25.9", "Ophthalmology", "low", ("cataract", "cloudy vision", "lens surgery"), "Same day", "2-4 weeks"),
    Procedure("gallbladder", "Laparoscopic cholecystectomy", "Gallstones", "K80.2", "General Surgery", "moderate", ("gall bladder", "gallbladder", "gallstone", "upper abdomen pain"), "1-2 days", "2-3 weeks"),
    Procedure("hernia", "Hernia repair", "Inguinal hernia", "K40.9", "General Surgery", "moderate", ("hernia", "groin swelling", "abdominal wall"), "Same day", "2-4 weeks"),
    Procedure("mri_brain", "MRI brain", "Neurological evaluation", "R90.8", "Radiology", "low", ("mri brain", "headache scan", "brain scan"), "Same day", "None"),
    Procedure("dialysis", "Hemodialysis session", "Chronic kidney disease", "N18.9", "Nephrology", "moderate", ("dialysis", "kidney failure", "creatinine"), "Same day", "None"),
    Procedure("chemotherapy", "Chemotherapy cycle", "Malignant neoplasm", "C80.1", "Oncology", "major", ("cancer", "chemo", "chemotherapy", "tumor"), "Same day", "1-2 days"),
    Procedure("radiotherapy", "Radiotherapy fraction", "Malignant neoplasm", "C80.1", "Oncology", "major", ("radiation therapy", "radiotherapy", "cancer radiation"), "Same day", "None"),
    Procedure("hip_replacement", "Hip replacement", "Osteoarthritis of hip", "M16.9", "Orthopedics", "major", ("hip pain", "hip replacement", "hip arthritis"), "3-5 days", "4-8 weeks"),
    Procedure("fracture_fixation", "Fracture fixation", "Fracture of limb", "T14.2", "Orthopedics", "moderate", ("fracture", "broken bone", "plate surgery"), "2-4 days", "6-12 weeks"),
    Procedure("tonsillectomy", "Tonsillectomy", "Chronic tonsillitis", "J35.0", "ENT", "low", ("tonsil", "tonsillitis", "throat infection"), "Same day", "1-2 weeks"),
    Procedure("sinus_surgery", "Functional endoscopic sinus surgery", "Chronic sinusitis", "J32.9", "ENT", "moderate", ("sinus", "blocked nose", "fess"), "Same day", "1-2 weeks"),
    Procedure("hysterectomy", "Hysterectomy", "Uterine disorder", "N85.9", "Gynecology", "major", ("hysterectomy", "uterus removal", "fibroid"), "2-3 days", "4-6 weeks"),
    Procedure("ivf_cycle", "IVF cycle", "Female infertility", "N97.9", "Fertility", "major", ("ivf", "fertility", "test tube baby"), "Same day", "1-2 days"),
    Procedure("endoscopy", "Upper GI endoscopy", "Digestive disorder", "K30", "Gastroenterology", "low", ("endoscopy", "gastric", "stomach scope"), "Same day", "None"),
    Procedure("colonoscopy", "Colonoscopy", "Bowel evaluation", "K63.9", "Gastroenterology", "low", ("colonoscopy", "colon", "blood in stool"), "Same day", "None"),
    Procedure("angiography", "Coronary angiography", "Ischemic heart disease evaluation", "I25.9", "Cardiology", "moderate", ("angiography", "heart test", "coronary test"), "Same day", "1-2 days"),
    Procedure("bypass", "CABG bypass surgery", "Coronary artery disease", "I25.1", "Cardiology", "major", ("bypass", "cabg", "heart bypass"), "5-7 days", "6-12 weeks"),
    Procedure("pacemaker", "Pacemaker implantation", "Cardiac rhythm disorder", "I49.9", "Cardiology", "major", ("pacemaker", "slow heartbeat", "rhythm"), "1-2 days", "4-6 weeks"),
    Procedure("prostate", "Prostate surgery", "Prostate enlargement", "N40", "Urology", "moderate", ("prostate", "urine problem", "turp"), "2-3 days", "4-6 weeks"),
    Procedure("kidney_stone", "Kidney stone removal", "Urinary calculus", "N20.0", "Urology", "moderate", ("kidney stone", "renal stone", "ureteroscopy"), "Same day", "1-2 weeks"),
    Procedure("dengue", "Dengue inpatient care", "Dengue fever", "A90", "Internal Medicine", "moderate", ("dengue", "platelet", "fever"), "3-5 days", "1-2 weeks"),
    Procedure("pneumonia", "Pneumonia admission", "Pneumonia", "J18.9", "Pulmonology", "moderate", ("pneumonia", "breathing infection", "lung infection"), "3-5 days", "2-4 weeks"),
    Procedure("asthma", "Asthma emergency care", "Asthma", "J45.9", "Pulmonology", "low", ("asthma", "wheezing", "breathlessness"), "Same day", "1-2 days"),
    Procedure("icu_day", "ICU day care", "Critical illness", "Z99.8", "Critical Care", "major", ("icu", "ventilator", "critical care"), "1-3 days", "Varies"),
    Procedure("nicu", "NICU day care", "Neonatal intensive care", "P07.3", "Neonatology", "major", ("nicu", "newborn icu", "premature baby"), "Varies", "Varies"),
    Procedure("physiotherapy", "Physiotherapy package", "Rehabilitation need", "Z50.1", "Rehabilitation", "low", ("physio", "physiotherapy", "rehab"), "Outpatient", "Varies"),
    Procedure("dental_implant", "Dental implant", "Tooth loss", "K08.1", "Dental", "moderate", ("dental implant", "tooth implant", "missing tooth"), "Same day", "3-6 months"),
    Procedure("root_canal", "Root canal treatment", "Dental pulp disease", "K04.0", "Dental", "low", ("root canal", "tooth pain", "rct"), "Same day", "1-2 days"),
    Procedure("lasik", "LASIK", "Refractive error", "H52.1", "Ophthalmology", "low", ("lasik", "laser eye", "spectacles removal"), "Same day", "1-2 weeks"),
    Procedure("thyroidectomy", "Thyroidectomy", "Thyroid disorder", "E04.9", "Endocrine Surgery", "major", ("thyroid surgery", "thyroidectomy", "goiter"), "1-2 days", "2-4 weeks"),
    Procedure("diabetes_admission", "Diabetes stabilization admission", "Diabetes mellitus", "E11.9", "Endocrinology", "moderate", ("diabetes", "sugar high", "insulin admission"), "2-4 days", "Ongoing"),
    Procedure("stroke_care", "Stroke acute care", "Stroke", "I64", "Neurology", "major", ("stroke", "paralysis", "slurred speech"), "4-7 days", "3-6 months"),
    Procedure("migraine", "Migraine evaluation", "Migraine", "G43.9", "Neurology", "low", ("migraine", "headache", "severe headache"), "Outpatient", "None"),
    Procedure("depression", "Psychiatry consultation package", "Depressive episode", "F32.9", "Psychiatry", "low", ("depression", "anxiety", "mental health"), "Outpatient", "Ongoing"),
    Procedure("skin_biopsy", "Skin biopsy", "Skin lesion", "D48.5", "Dermatology", "low", ("skin biopsy", "mole", "skin lesion"), "Same day", "1-2 weeks"),
    Procedure("burn_care", "Burn wound care", "Burn injury", "T30.0", "Plastic Surgery", "moderate", ("burn", "burns", "wound dressing"), "Varies", "Varies"),
    Procedure("varicose_vein", "Varicose vein laser treatment", "Varicose veins", "I83.9", "Vascular Surgery", "moderate", ("varicose", "leg veins", "vein laser"), "Same day", "1-2 weeks"),
    Procedure("transplant_eval", "Transplant evaluation", "Organ failure evaluation", "Z01.8", "Transplant Medicine", "major", ("transplant", "organ transplant", "liver transplant"), "3-5 days", "Varies"),
    Procedure("liver_cirrhosis", "Liver cirrhosis admission", "Cirrhosis", "K74.6", "Hepatology", "major", ("cirrhosis", "liver failure", "ascites"), "4-7 days", "Ongoing"),
    Procedure("biopsy_guided", "Image-guided biopsy", "Suspicious lesion", "R93.8", "Interventional Radiology", "moderate", ("biopsy", "guided biopsy", "tumor biopsy"), "Same day", "1-2 days"),
    Procedure("maternity_package", "Maternity package", "Pregnancy care", "Z34.9", "Obstetrics", "moderate", ("maternity", "pregnancy package", "antenatal"), "2-3 days", "4-6 weeks"),
    Procedure("vaccination", "Vaccination package", "Immunization", "Z23", "Pediatrics", "low", ("vaccine", "vaccination", "immunization"), "Outpatient", "None"),
    Procedure("pediatric_fever", "Pediatric fever care", "Fever in child", "R50.9", "Pediatrics", "low", ("child fever", "pediatric fever", "baby fever"), "1-2 days", "1-2 weeks"),
    Procedure("sleep_study", "Sleep study", "Sleep apnea", "G47.3", "Pulmonology", "low", ("sleep study", "snoring", "sleep apnea"), "1 night", "None"),
    Procedure("obesity_surgery", "Bariatric surgery", "Obesity", "E66.9", "Bariatric Surgery", "major", ("weight loss surgery", "bariatric", "obesity surgery"), "2-3 days", "4-6 weeks"),
]
...
def map_clinical_query(query: str) -> dict[str, Any]:
    ...
    return {
        ...
        "typical_stay": best_proc.get("typical_stay", "3-5 days"),
        "recovery_time": best_proc.get("recovery_time", "4-8 weeks"),
    }
